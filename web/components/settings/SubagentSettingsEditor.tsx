    ...
    <div>
      <SettingsPageHeader
        ...
        description={tr({
          ...
          en: `Model, reasoning effort, and run parameters AriseHub Agent Playground uses with the local ${displayName}. These override the CLI defaults; leave blank to keep the CLI's own default.`,
        })}
      />
        ...
        <>
          ...
          <SettingSection
            ...
            description={tr({
              ...
              en: "The model and reasoning effort AriseHub Agent Playground uses when consulting this agent.",
            })}
          >
            <SettingRow
              ...
              description={tr({
                ...
                en: "When off, AriseHub Agent Playground won't consult this agent in chat.",
              })}
              control={
                <Toggle
          ...
          {features.systemPrompt && (
            <SettingSection
              ...
              description={`${tr(
                ...
                en: "Blank uses AriseHub Agent Playground's default delegate instruction.",
              })}`}
            >
              <div className="py-4">
                <textarea
          ...
          <SettingSection
            ...
            description={tr({
              zh: "DeepTutor 无人值守地驱动该智能体——默认值确保它不会卡在等待确认上。",
                en: "AriseHub Agent Playground drives the agent unattended — the defaults ensure it never stalls waiting for an approval prompt.",
            })}
          >
            ...
            {features.forwardImages && (
              <SettingRow
                ...
                description={tr({
                  ...
                  en: "Let AriseHub Agent Playground forward image attachments from the chat turn to this agent.",
                })}
                control={
                  <Toggle
